...
import { 
  ...
  FaCreditCard, FaNotesMedical, FaUserFriends, FaArrowLeft,
  FaBuilding, FaDoorOpen, FaMoneyBillWave, FaCalendarAlt,
  FaPrescriptionBottleAlt, FaFlask, FaProcedures
} from 'react-icons/fa';
import Layout from '@/components/Layout';

const API_URL = import.meta.env.VITE_BACKEND_URL;

const AdminAdmitPatient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate(`/dashboard/admin/ipd/admissions`);
      } else {
    ...
    <div className="min-h-screen bg-slate-50/50 p-6 font-sans">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <button onClick={() => navigate('/dashboard/admin/ipd/dashboard')} className="p-2 hover:bg-white rounded-xl transition-colors">
...
export default AdminAdmitPatient;