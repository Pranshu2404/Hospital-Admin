...
const NurseList = () => {
    ...
    const filteredStaff = staffMembers
        .filter((staff) => staff.role && staff.role.toLowerCase() === 'nurse')
        .filter((staff) =>
        ...
        <div className="p-6">
            <div className="bg-white rounded-xl shadow p-6">
                <div className="flex justify-between items-center mb-4">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800">Nurse Directory</h2>
                        <p className="text-gray-500">Manage all hospital Nurses</p>
                    </div>
                    <Button onClick={() => navigate('/dashboard/admin/add-nurse')}>+ Add Nurse</Button>
                </div>
                    ...
                    <table className="min-w-[900px] w-full text-sm text-gray-700 table-auto">
                        ...
                        <tbody>
                            ...
                            {!loading && filteredStaff.length === 0 && (
                                <tr>
                                    <td colSpan="6" className="text-center py-4 text-gray-500">No nurses found.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
